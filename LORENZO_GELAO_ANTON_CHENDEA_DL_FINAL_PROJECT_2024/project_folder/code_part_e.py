...
def train_model(model, train_loader, val_loader, device, criterion, optimizer, lr_scheduler, num_epochs=25,
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        # Moyenne de la perte sur l'ensemble de validation
        ...
        print(f'[Val] Kappa: {val_kappa:.4f} Accuracy: {val_accuracy:.4f} '
              f'Precision: {val_precision:.4f} Recall: {val_recall:.4f} Loss: {avg_val_loss:.4f}')
    ...
    metrics = [train_accuracies, train_losses, val_accuracies, val_losses]
...
if __name__ == '__main__':
    ...
    model, metrics = train_model(
        ...
        checkpoint_path='./model_a_resnet_34.pth'
    )

    # Load the pretrained checkpoint
    state_dict = torch.load('./model_a_resnet_34.pth', map_location='cpu')
